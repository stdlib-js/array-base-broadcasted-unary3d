...
```javascript
bunary3d = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-broadcasted-unary3d@v0.1.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-base-broadcasted-unary3d@v0.1.0-umd/browser.js"></script>
```
